...
?>
                                                ...
                                                <form action="#" method="POST">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" class="form-control" name="ftype" value='<?php echo $row['Food_Type']?>'/>
                                                            </div>
                                                        </div>
                                                    </div>
													<div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" class="form-control" name="img" value='<?php echo $row['Profile_Image']?>' />
                                                            </div>
                                                        </div>
                                                    </div>
													<div class="form-group-inner">
	...
	if($_SERVER["REQUEST_METHOD"]=="POST")
	{
		if(isset($_POST["pname"]) && isset($_POST["desc"]) && isset($_POST["price"])
			&& isset($_POST["ftype"]) && isset($_POST["img"])&& isset($_POST["dur"]))
			$pname=$_POST["pname"];
			$desc=$_POST["desc"];
			$price=$_POST["price"];
			$ftype=$_POST["ftype"];
		...
		if($pname!='' && $desc!='' && $price!='' && $ftype!='' && $img!='' && $dur!='')
		{
			$sql = "update tiffin_service_package set Package_Name='".$pname."',Description='".$desc."',
			Price='".$price."',Food_Type='".$ftype."',Profile_Image='".$img."',Duration='".$dur."'";
			//echo $sql;
			//die;
