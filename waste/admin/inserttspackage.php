...
?>
													...
													<div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
																...
																<?php $sql3="select * from membership_package";
																$result3=mysqli_query($conn,$sql3);
																while($row3=mysqli_fetch_array($result3))
																{
															?>
															<option value="<?php echo $row3['MPackage_Id']; ?>">
															<?php echo $row3['Package_Name']; ?></option>
															<?php															
															}
															?>
															</select>
	...
	if($_SERVER["REQUEST_METHOD"]=="POST")
	{
		...
		{
			$sql="INSERT INTO area (Package_Name,Description,Price,Food_Type,Duration)VALUES('".$pname."','".$desc."','".$price."','".$ftype."',''.$dur.'')";
