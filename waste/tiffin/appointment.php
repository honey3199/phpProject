...
<body>
	...
	<?php
            ...
            where a.House_Id = h.House_Id and a.User_Id = u.User_Id and a.User_Id='".$id."'";
                                    ...
                                    <table id="table" data-toggle="table">
                                        ...
                                        <tbody>
												...
												echo "<tr>";
													...
													//echo "<td><a href=\"categoryupdate.php?id=$row[App_Id]\">
													//<img src=\"edit.png\" height='20' width='20'/></a> </td>";
