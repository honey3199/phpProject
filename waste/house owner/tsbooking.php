...
<body>
	...
	<?php
			...
			$id=$_SESSION['User_Id'];
			$sql = "SELECT * FROM tiffin_service_booking b JOIN user1 u JOIN tiffin_service_package t JOIN area a WHERE u.User_Id='".$id."' and b.TSPackage_Id=t.TSPackage_Id and b.A_Code=a.A_Code and b.IsActive=1";
