...
<!-- Mirrored from spruko.com/demo/kharna/html/Kharna_Admin-purple/formelements.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 Dec 2018 06:26:44 GMT -->
<head>

		<meta charset="UTF-8">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<title>House Harmony-Admin Dashboard</title>
			...
			<div class="main-wrapper" >
				<nav class="navbar navbar-expand-lg main-navbar">
					<a class="header-brand" href="index.html">
						<img src="img3.jpg" class="header-brand-img" alt="Kharna-Admin  logo">
					</a>
					...
					<ul class="navbar-nav navbar-right">
							...
							<div class="dropdown-menu dropdown-list dropdown-menu-right">
								...
								<div class="dropdown-list-content">
									<a href="#" class="dropdown-item dropdown-item-unread">
										<img alt="image" src="img1.jpg" class="rounded-circle dropdown-item-img">
						...
						<li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg">
							<img src="img1.jpg" alt="profile-user" class="rounded-circle w-32">
							<div class="d-sm-none d-lg-inline-block">Nakshi Patel</div></a>
					...
					<div class="app-sidebar__user">
					    <div class="dropdown">
							<a class="nav-link pl-2 pr-2 leading-none d-flex" data-toggle="dropdown" href="#">
								<img alt="image" src="img1.jpg" class=" avatar-md rounded-circle">
								<span class="ml-2 d-lg-block">
									<span class="text-white app-sidebar__user-name mt-5">Nakshi Patel</span><br>
				...
				<div class="app-content">
					<section class="section">
                    	<ol class="breadcrumb">
							...
							<div class="col-lg-17 col-xl-12 col-md-10 col-sm-17">
								<div class="card">
	...
	?>
				...
				<footer class="main-footer">
					<div class="text-center">
						Copyright &copy;House Harmony-Admin 2018. Design By<a href="https://spruko.com/"> Spruko</a>
					</div>
				</footer>
