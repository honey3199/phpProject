...
$result = $database->runQuery("SELECT U_Name,Package_Name,A_Name,SB_Date,SB_Status 
			FROM tiffin_service_booking b JOIN user1 u join area a JOIN tiffin_service_package t 
			WHERE a.A_Code=b.A_Code and b.User_Id=u.User_Id && b.TSPackage_Id=t.TSPackage_Id");
