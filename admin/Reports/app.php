...
$result = $database->runQuery("SELECT H_Name,U_Name,App_Date,App_Time,Status FROM appointment a join house h JOIN user1 u
where a.House_Id = h.House_Id and a.User_Id = u.User_Id");
