...
<body>
	...
	<?php
			...
			$sql = "SELECT * FROM tiffin_service_booking b JOIN user1 u join area a JOIN tiffin_service_package t 
			WHERE a.A_Code=b.A_Code and b.User_Id=u.User_Id && b.TSPackage_Id=t.TSPackage_Id order by b.TSPackage_Id";
			if (isset($_GET['tid']))
			{
				$id = $_GET['tid'];
				$sql = "SELECT * FROM tiffin_service_booking b JOIN user1 u join area a JOIN tiffin_service_package t 
			WHERE a.A_Code=b.A_Code and b.User_Id=u.User_Id && b.TSPackage_Id=t.TSPackage_Id and t.TSPackage_Id='".$id."' order by b.TSPackage_Id";
			}
                            ...
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
									...
									<div class="add-product">
										<a href="Reports/book.php">Generate Report</a>
									</div>
                                </div>
                            </div>
