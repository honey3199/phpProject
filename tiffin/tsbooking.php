...
<body>
	...
	<?php
			...
			WHERE b.User_Id=u.User_Id and a.A_Code=b.A_Code and b.TSPackage_Id=t.TSPackage_Id and b.IsActive=1 and t.User_Id='".$id."'";
                            ...
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
									...
									<div class="add-product">
										<a href="Reports/book.php?id=<?php echo $id;?>">Generate Report</a>
									</div>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
												...
												echo "<tr>";
													...
													else if($row['SB_Status'] == 'Booked')
													{
														echo "<td>
																<a href=\"canclebooking.php?tid=$row[TSBook_Id]\"style='color:blue'><u>Cancle Booking</u></a>
															</td>";
													}
													else
													{
